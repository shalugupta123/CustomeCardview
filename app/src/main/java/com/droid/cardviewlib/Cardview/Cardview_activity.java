...
public class Cardview_activity extends FrameLayout {
    ...
    public Cardview_activity(@NonNull Context context) {
        this(context, (AttributeSet)null);
    }

    public Cardview_activity(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    public Cardview_activity(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCardViewDelegate = new CardViewDelegate() {
            ...
            public void setCardBackground(Drawable drawable) {
                ...
                Cardview_activity.this.setBackgroundDrawable(drawable);
            }

            public boolean getUseCompatPadding() {
                return Cardview_activity.this.getUseCompatPadding();
            }

            public boolean getPreventCornerOverlap() {
                return Cardview_activity.this.getPreventCornerOverlap();
            }

            public void setShadowPadding(int left, int top, int right, int bottom) {
                Cardview_activity.this.mShadowBounds.set(left, top, right, bottom);
                Cardview_activity.super.setPadding(left + Cardview_activity.this.mContentPadding.left, top + Cardview_activity.this.mContentPadding.top, right + Cardview_activity.this.mContentPadding.right, bottom + Cardview_activity.this.mContentPadding.bottom);
            }

            public void setMinWidthHeightInternal(int width, int height) {
                if (width > Cardview_activity.this.mUserSetMinWidth) {
                    Cardview_activity.super.setMinimumWidth(width);
                }

                if (height > Cardview_activity.this.mUserSetMinHeight) {
                    Cardview_activity.super.setMinimumHeight(height);
                }
        ...
        if (a.hasValue(R.styleable.CardView_cardBackgroundColor)) {
            ...
            backgroundColor = ColorStateList.valueOf(hsv[2] > 0.5F ? this.getResources().getColor(R.color.cardview_light_background) : this.getResources().getColor(R.color.cardview_dark_background));
        }

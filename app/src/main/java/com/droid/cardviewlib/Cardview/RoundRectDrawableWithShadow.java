...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = resources.getColor(android.R.color.background_light);
        this.mShadowEndColor = resources.getColor(android.R.color.holo_blue_bright);
        this.mInsetShadow = resources.getDimensionPixelSize(android.R.dimen.app_icon_size);
